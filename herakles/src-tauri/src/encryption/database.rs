    ...
    */
    pub fn connect(db_path_str: &str) -> Result<Self> {
        ...
        let pool = Pool::new(manager)?;
      {
        ...
        Ok(Database { path: db_path_str.to_string(), db: pool })
    }
    ...
    pub fn encrypt_file(&self, path: String, key: &[u8]) -> Result<bool> {
    ...
    pub fn decrypt_file(&self, path: String, key: &[u8]) -> Result<bool> {
